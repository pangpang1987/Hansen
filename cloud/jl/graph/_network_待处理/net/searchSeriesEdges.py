...
from    jl.tools.toolsClassObject   import  fade_j_class

#¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥
#
#   搜索串联分支
#
def _search_series_edges(net, eids=None,graph="UNDIRECTED") :

    if not eids             :   return _node_driven(net)            # 节点驱动型, 搜索全部串联分支

    if type(eids) is str    :   return _edge_driven(net,[eids])     # 单一分支驱动

    if type(eids) is list   :   return _edge_driven(net,eids)
#--------------------------------------------------------------------------------------------------------------------------
...
#   搜索串联分支
#
def _find_edge(net, v,eid,series,headend) :
    if v.dgree != 2 or v.color : return series
    ...
    series = _find_edge(net,v,e.id,series,headend)
    return series
#--------------------------------------------------------------------------------------------------------------------------
...
#   节点驱动
# 
def _node_driven(net) :
    
    fade_j_class(net.Nodes)

    seriess = list()

    for v in net.Nodes :

        if v.dgree != 2 or v.color: continue
        ...
        # head
        if e1.s == v.id :   node = net.idMapNode[e1.t]
        else            :   node = net.idMapNode[e1.s]
        series = _find_edge(net,node,e1.id,series,"HEAD")
        
        # end
        if e2.s == v.id :   node = net.idMapNode[e2.t]
        else            :   node = net.idMapNode[e2.s]
        series = _find_edge(net,node ,e2.id,series,"END")

        if len(series) > 1 : seriess.append(series)
    return seriess  
#--------------------------------------------------------------------------------------------------------------------------
...
def _edge_driven(net,eids) :
    ...
    for eid in eids :
        ...
        series = _find_edge(net,s,eid,series,headend="HEAD")
        series = _find_edge(net,t,eid,series,headend="END")
